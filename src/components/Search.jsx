...
function Search() {
  ...
  return (
    <div className="search relative h-[65rem] px-[5rem] bg-[#081730] pt-[14rem] pb-[10rem] mt-[-15rem] z-[1] flex items-center justify-between rounded-b-[5rem]">
      {/* left side */}
      <div className="left flex-1">
        ...
        <motion.img
          ...
          alt=""
          className="w-[16rem] top-[23rem] absolute"
        />{" "}
